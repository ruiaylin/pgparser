...
import (
	fmt "fmt"
	geopb "github.com/ruiaylin/pgparser/types/geo/geopb"
	github_com_cockroachdb_cockroach_pkg_geo_geopb "github.com/ruiaylin/pgparser/types/geo/geopb"
...
type GeoMetadata struct {
	SRID      github_com_cockroachdb_cockroach_pkg_geo_geopb.SRID `protobuf:"varint,1,opt,name=srid,casttype=github.com/ruiaylin/pgparser/types/geo/geopb.SRID" json:"srid"`
...
func (m *InternalType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ArrayContents != nil {
		...
		n1, err1 := m.ArrayContents.MarshalTo(dAtA[i:])
		if err1 != nil {
			return 0, err1
		}
		i += n1
	...
	if m.IntervalDurationField != nil {
		...
		n2, err2 := m.IntervalDurationField.MarshalTo(dAtA[i:])
		if err2 != nil {
			return 0, err2
		}
		i += n2
	...
	if m.GeoMetadata != nil {
		...
		n3, err3 := m.GeoMetadata.MarshalTo(dAtA[i:])
		if err3 != nil {
			return 0, err3
		}
		i += n3
	...
	if m.UDTMetadata != nil {
		...
		n4, err4 := m.UDTMetadata.MarshalTo(dAtA[i:])
		if err4 != nil {
			return 0, err4
		}
		i += n4
