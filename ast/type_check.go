...
// introspection globally and on each sub-ast.
//
...
// ast. Like with Expr.TypeCheck, it is not valid to provide a nil desired
...
func TypeCheck(
	...
	if desired == nil {
		return nil, errors.AssertionFailedf(
			"the desired type for ast.TypeCheck cannot be nil, use types.Any instead: %T", expr)
	}
