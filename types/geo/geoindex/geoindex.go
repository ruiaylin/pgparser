...
import (
	...
	"github.com/ruiaylin/pgparser/types/geo/geogfn"
...
func coveredBy(_ context.Context, rc *s2.RegionCoverer, r []s2.Region) RPKeyExpr {
	...
	// of another. Arrange these cells and their ancestors in a quad-ast. Any cell
...
// - the path for each leaf to the root of that quad-ast. The index entries
