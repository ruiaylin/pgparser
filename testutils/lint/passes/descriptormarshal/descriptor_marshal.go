...
const sqlbasePkg = "github.com/ruiaylin/pgparser/sqlbase"
...
var allowedFunctions = []string{
	"(*github.com/ruiaylin/pgparser/sqlbase.Descriptor).Table",
	"github.com/ruiaylin/pgparser/sqlbase.TestDefaultExprNil",
	"github.com/ruiaylin/pgparser/sqlbase.TestKeysPerRow",
	"github.com/ruiaylin/pgparser/pkg/ccl/backupccl.readBackupManifest",
}
