...
import (
	...
	"github.com/ruiaylin/pgparser/sem/builtins"
	_ "github.com/ruiaylin/pgparser/pkg/testutils/buildutil"
...
//
//     https://github.com/ruiaylin/pgparser/blob/master/licenses/CCL.txt
`)
	...
	t.Run("TestForbiddenImports", func(t *testing.T) {
		...
		forbiddenImports := map[string]string{
			...
			"golang.org/x/sync/singleflight":              "github.com/ruiaylin/pgparser/utils/syncutil/singleflight",
			"syscall":                                     "sysutil",
		...
		settingsPkgPrefix := `github.com/ruiaylin/pgparser/settings`
		if err := stream.ForEach(stream.Sequence(
			filter,
			stream.Sort(),
			stream.Uniq(),
