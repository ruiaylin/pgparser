...
import (
	...
	"github.com/ruiaylin/pgparser/testutils/sqlutils"
...
var (
	...
	testPrettyCfg   = func() ast.PrettyCfg {
...
func runTestPrettyData(
	t *testing.T, prefix string, cfg ast.PrettyCfg, matches []string, short bool,
) {
...
func TestPrettyExprs(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	tests := map[ast.Expr]string{
		&ast.CastExpr{
			Expr: ast.NewDString("foo"),
