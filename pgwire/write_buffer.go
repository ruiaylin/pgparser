...
type writeBuffer struct {
	...
	textFormatter   *ast.FmtCtx
	simpleFormatter *ast.FmtCtx
...
func (b *writeBuffer) init(bytecount *metric.Counter) {
	...
	b.textFormatter = ast.NewFmtCtx(ast.FmtPgwireText)
	b.simpleFormatter = ast.NewFmtCtx(ast.FmtSimple)
}
...
func (b *writeBuffer) writeFromFmtCtx(fmtCtx *ast.FmtCtx) {
	if b.err == nil {
...
func (b *writeBuffer) writeLengthPrefixedDatum(d ast.Datum) {
