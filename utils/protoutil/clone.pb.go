...
import (
	fmt "fmt"
	github_com_cockroachdb_cockroach_pkg_util_uuid "github.com/ruiaylin/pgparser/utils/uuid"
...
type RecursiveAndUncloneable struct {
	...
	Uuid github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=uuid,proto3,customtype=github.com/ruiaylin/pgparser/utils/uuid.UUID" json:"uuid"`
}
...
func (m *RecursiveAndUncloneable) MarshalTo(dAtA []byte) (int, error) {
	...
	n2, err2 := m.Uuid.MarshalTo(dAtA[i:])
	if err2 != nil {
		return 0, err2
	}
	i += n2
