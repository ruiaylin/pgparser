...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_37862072f84baf58, []int{0}
}
...
func (*LogRecord_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_37862072f84baf58, []int{0, 0}
}
...
func (*RecordedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_37862072f84baf58, []int{1}
}
...
func (*NormalizedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_37862072f84baf58, []int{2}
}
...
func init() { proto.RegisterFile("util/tracing/recorded_span.proto", fileDescriptor_37862072f84baf58) }

var fileDescriptor_37862072f84baf58 = []byte{
...
func (m *LogRecord) MarshalTo(dAtA []byte) (int, error) {
	...
	n1, err1 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Time, dAtA[i:])
	if err1 != nil {
		return 0, err1
	}
	i += n1
...
func (m *RecordedSpan) MarshalTo(dAtA []byte) (int, error) {
	...
	n2, err2 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.StartTime, dAtA[i:])
	if err2 != nil {
		return 0, err2
	}
	i += n2
	...
	n3, err3 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Duration, dAtA[i:])
	if err3 != nil {
		return 0, err3
	}
	i += n3
	...
	if m.Stats != nil {
		...
		n4, err4 := m.Stats.MarshalTo(dAtA[i:])
		if err4 != nil {
			return 0, err4
		}
		i += n4
...
func (m *NormalizedSpan) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintRecordedSpan(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.StartTime)))
	n5, err5 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.StartTime, dAtA[i:])
	if err5 != nil {
		return 0, err5
	}
	i += n5
	...
	i++
	i = encodeVarintRecordedSpan(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.Duration)))
	n6, err6 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Duration, dAtA[i:])
	if err6 != nil {
		return 0, err6
	}
	i += n6
